return {
    ...
    config = function()
        ...
        keymap("n", "<Leader>fa",
            function() return require('telescope.builtin').find_files(themes.get_ivy({ hidden = true })) end, opts)
        ...
        keymap("n", "<Leader>lg",
            function() return require('telescope.builtin').live_grep({ grep_open_files = true }) end, opts)
