...
keymap("n", "<Leader>fr", "<cmd>lua require('Telescope').extensions.file_browser.file_browser<cr>", {noremap = true})
...
-- harpoon navigation
keymap("n", "<Leader>mm", "require('harpoon.mark').add_file()<cr>", opts)
keymap("n", "<Leader>mt", "require('harpoon.ui').toggle_quick_menu()<cr>", opts)
keymap("n", "<Leader>mm", "require('harpoon.ui').nav_file(1)<cr>", opts)
keymap("n", "<Leader>mm", "require('harpoon.ui').nav_file(2)<cr>", opts)
keymap("n", "<Leader>mm", "require('harpoon.ui').nav_file(3)<cr>", opts)
keymap("n", "<Leader>mm", "require('harpoon.ui').nav_file(4)<cr>", opts)
keymap("n", "<Leader>mm", "require('harpoon.ui').nav_file(5)<cr>", opts)
