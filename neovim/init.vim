...
" nnoremap <leader>fc <cmd>Telescope current_buffer_fuzzy_find sorting_strategy=ascending<cr>
nnoremap <leader>fc <cmd>lua require('telescope.builtin').current_buffer_fuzzy_find({sorting_strategy = 'ascending'})<cr>
